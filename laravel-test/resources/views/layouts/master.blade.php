...
<head>
    ...
    {{-- --CSS-- --}}
     ...
     {{-- <link href="{{ asset('/assets/css/gallerycss/slick-theme.css') }}" rel="stylesheet" type="text/css" />
     <link href="{{ asset('/assets/css/gallerycss/slick.css') }}" rel="stylesheet" type="text/css" /> --}}
