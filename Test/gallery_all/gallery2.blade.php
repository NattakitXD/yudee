...
<head>
    ...
    <link rel="stylesheet" href="testcss/theme.js" type="text/css" />
...
<body>
                        ...
                        <ul class="list-inline pt-4 pr-5">
                            ...
                            <li class="list-inline-item mr-2">
                                <button
                                    ...
                                    data-bs-html="true" data-original-title="" title="">
                    ...
                    <div class="make-me-sticky " style="">
                        <div class="card border-0 widget-request-tour">
                            <ul class="list-inline nav nav-tabs d-flex " role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active px-3 text-yudee" data-toggle="tab" href="#schedule"
                                    ...
                                    <div class="tab-content pt-1 pb-0 px-0 shadow-none">
                                        ...
                                        <div class="tab-pane fade show active" id="schedule" role="tabpanel">
                                            ...
                                            <div class="slick-slider  " >
                                                ...
                                                <div class="box px-1 py-4  slick-active " data-slick-index="0" aria-hidden="false"
                                                ...
                                                <div class="box px-1 py-4 slick-slide " data-slick-index="0" aria-hidden="false"
                                                    style="width: 60px;" tabindex="0">
                                                    <div class="card pointer border-0 shadow-xxs-1" data-date="March 17, 2020">
                                                        <div class="card-body p-1 text-center">
                                                            <p class="day fs-12 text-muted lh-2 mb-0">
                                                                Tue</p>
                                                            <p class="date fs-18 text-heading lh-173 mb-0 font-weight-bold">
        ...
        <section class="pt-6 pb-8">
            <div class="container">
                ...
                <div class="slick-initialized slick-slider"
                    data-slick-options="{&quot;slidesToShow&quot;: 3, &quot;dots&quot;:false,&quot;arrows&quot;:false,&quot;responsive&quot;
                    ...
                    <div class="container slick-list draggable mr-0 " style="height: 419.913px;">
                        <div class=" d-flex justify-content-between">

                            <div class="box slick-slide slick-current slick-active " style="width: 343px;"
                                tabindex="0" data-slick-index="0" aria-hidden="false">
                                <div class="card shadow-hover-2 ">
                                    <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                                        <img src="{{ URL('https://templates.g5plus.net/homeid/images/properties-grid-07.jpg') }}"
                                    ...
                                    <div class="card-body pt-3">
                                        <h2 class="card-title fs-16 lh-2 mb-0"><a href="single-property-1.html"
                                                class="text-dark hover-primary" tabindex="0">Home in Metric
                                                Way</a></h2>
                                        <p class="card-text font-weight-500 text-gray-light mb-2">1421 San Pedro
                                            St, Los Angeles</p>
                                        ...
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item">
                                                <a href="#"
                                                    ...
                                                    data-toggle="tooltip" title="Wishlist" tabindex="0"
                                            ...
                                            <li class="list-inline-item">
                                                <a href="#"
                                                    ...
                                                    data-toggle="tooltip" title="Compare" tabindex="0"
                            ...
                            <div class="box slick-slide slick-active    " style="width: 343px;" tabindex="0"
                                data-slick-index="1" aria-hidden="false">
                                <div class="card shadow-hover-2">
                                    <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                                        <img src="{{ URL('https://templates.g5plus.net/homeid/images/properties-grid-05.jpg') }}"
                            ...
                            <div class="box slick-slide slick-active" style="width: 343px;" tabindex="0"
                                ...
                                <div class="card shadow-hover-2">
                                    <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                                        <img src="{{ URL('https://templates.g5plus.net/homeid/images/properties-grid-06.jpg') }}"
    ...
    <div class="bootstrap-timepicker-widget dropdown-menu timepicker-orient-left timepicker-orient-top open"
        style="top: 10257.6px; left: 45px;">
        <table>
            <tbody>
                <tr>
                    <td><a href="#" data-action="incrementHour"><span class="fal fa-angle-up"></span></a>
                    </td>
                    <td class="separator">&nbsp;</td>
                    <td><a href="#" data-action="incrementMinute"><span class="fal fa-angle-up"></span></a>
                    </td>
                    <td class="separator">&nbsp;</td>
                    <td class="meridian-column"><a href="#" data-action="toggleMeridian"><span
                                class="fal fa-angle-up"></span></a></td>
                </tr>
                <tr>
                    ...
                    <td class="separator">&nbsp;</td>
                    <td><input type="text" class="bootstrap-timepicker-meridian" maxlength="2"></td>
                </tr>
                <tr>
                    <td><a href="#" data-action="decrementHour"><span class="fal fa-angle-down"></span></a>
                    </td>
                    <td class="separator"></td>
                    <td><a href="#" data-action="decrementMinute"><span
                                class="fal fa-angle-down"></span></a></td>
                    <td class="separator">&nbsp;</td>
                    <td><a href="#" data-action="toggleMeridian"><span class="fal fa-angle-down"></span></a>
                    </td>
                </tr>
            </tbody>
        </table>
...
<script>
    $(document).ready(function(){
        $('.slick-prev').on('slick-arrow', function(){
            $('.your-slider-class').slick('slickPrev');
        });

        $('.slick-next').on('slick-arrow', function(){
            $('.your-slider-class').slick('slickNext');
        });
    });
</script>
...
{{-- tabpanel --}}
<script src="testcss/jquery.min.js"></script>
<script src="testcss/bootstrap/bootstrap.bundle.js"></script>
<script src="js/theme.js"></script>

{{-- Image popup --}}
<script src="testcss/magnific-popup/jquery.magnific-popup.min.js"></script>

{{--  --}}
<script src="testcss/jquery-ui/jquery-ui.min.js"></script>
<script src="testcss/bootstrap-select/js/bootstrap-select.min.js"></script>
<script src="testcss/waypoints/jquery.waypoints.min.js"></script>
<script src="testcss/counter/countUp.js"></script>
<script src="testcss/chartjs/Chart.min.js"></script>
<script src="testcss/dropzone/js/dropzone.min.js"></script>
<script src="testcss/timepicker/bootstrap-timepicker.min.js"></script>
<script src="testcss/hc-sticky/hc-sticky.min.js"></script>
<script src="testcss/jparallax/TweenMax.min.js"></script>
<script src="testcss/mapbox-gl/mapbox-gl.js"></script>
<script src="testcss/dataTables/jquery.dataTables.min.js"></script>
...
<script src="testcss/slick/slick.min.js"></script>
